...
public  class FireServiceAdapter extends RecyclerView.Adapter<FireServiceAdapter.MyViewHolder> {
    ...
    public FireServiceAdapter(Context context,Activity activity, List<Model> itemList){
