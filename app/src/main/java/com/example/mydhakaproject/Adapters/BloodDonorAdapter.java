...
public  class BloodDonorAdapter extends RecyclerView.Adapter<BloodDonorAdapter.MyViewHolder> {
    ...
    public BloodDonorAdapter(Context context,Activity activity, List<BloodDonorModel> itemList){
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.category.setText(list.get(position).getBlood_group());
    ...
    public void filteredList(ArrayList<BloodDonorModel> filteredList){
        list = filteredList;
